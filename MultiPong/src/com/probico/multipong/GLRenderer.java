...
//	private Ball ball;
	...
	public void onSurfaceCreated(GL10 unused, EGLConfig config) {
		...
		bottomPaddle = new Rectangle(this, new float[] { -PADDLE_WIDTH/2, -CENTER_TO_PADDLE, 0.0f, // top
				...
				PADDLE_WIDTH/2, -CENTER_TO_PADDLE, 0.0f }, R.drawable.paddle_green, false); // top right)
		...
		topPaddle = new Rectangle(this, new float[] { -PADDLE_WIDTH/2, CENTER_TO_PADDLE + PADDLE_HEIGHT, 0.0f, // top
				...
				PADDLE_WIDTH/2, CENTER_TO_PADDLE + PADDLE_HEIGHT, 0.0f }, R.drawable.paddle_green, true); // top right)
		...
		background = new Rectangle(this, new float[] { -1.45f, CENTER_TO_VERTICAL_EDGE, 0.0f, // top
				...
				1.45f, CENTER_TO_VERTICAL_EDGE, 0.0f }, R.drawable.backgroundpattern_space, false); // top right)
